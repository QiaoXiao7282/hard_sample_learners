...
class simple_CNN(nn.Module):
    ...
    def forward(self, x):
        ...
        final_x = self.classifier(feature)
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, Istiny=False):
...
def ResNet18(c=1000, Istiny=False):
    return ResNet(BasicBlock, [2,2,2,2],c, Istiny=Istiny)

def ResNet34(c=10, Istiny=False):
    return ResNet(BasicBlock, [3,4,6,3],c, Istiny=Istiny)
